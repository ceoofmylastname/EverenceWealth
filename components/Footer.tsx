...
const Footer: React.FC = () => {
  return (
    <footer className="bg-evergreen text-white pt-40 pb-12 border-t border-white/10">
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid md:grid-cols-4 lg:grid-cols-6 gap-20 mb-32">
          ...
          <div className="space-y-10">
            <h4 className="text-[10px] font-black uppercase tracking-[0.3em] text-white/30">Quick Links</h4>
            <ul className="space-y-5">
              {['About Our Process', 'Tax Optimization', 'Indexed Life', 'Schedule Consultation'].map((link) => (
                <li key={link}>
                  <a href="#" className="text-white/70 hover:text-white transition-colors text-sm font-bold uppercase tracking-widest">
                    {link}
                  </a>
                </li>
              ))}
          ...
          <div className="space-y-10">
            <h4 className="text-[10px] font-black uppercase tracking-[0.3em] text-white/30">Resources</h4>
            <ul className="space-y-5">
          ...
          <div className="md:col-span-2 space-y-10">
            <h4 className="text-[10px] font-black uppercase tracking-[0.3em] text-white/30">Contact</h4>
            <ul className="space-y-8">
              <li className="flex items-start gap-6">
                <MapPin className="text-white/30 mt-1 shrink-0" size={24} />
                <span className="text-white/70 font-light text-lg">455 Market St, Suite 1940<br />San Francisco, CA 94105</span>
              </li>
              <li className="flex items-center gap-6">
                <Phone className="text-white/30 shrink-0" size={24} />
                <span className="text-white/70 font-light text-lg">(555) 123-4567</span>
              </li>
              <li className="flex items-center gap-6">
                <Mail className="text-white/30 shrink-0" size={24} />
                <span className="text-white/70 font-light text-lg">info@everencewealth.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-16 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-10">
          <div className="text-[10px] font-black uppercase tracking-[0.3em] text-white/30 max-w-2xl text-center md:text-left leading-relaxed">
