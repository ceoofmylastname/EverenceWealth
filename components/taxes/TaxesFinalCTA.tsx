        ...
        <section id="assessment" className="relative overflow-hidden bg-gradient-to-br from-[#020806] via-[#0a1f1a] to-[#1A4D3E] py-24 md:py-40">
            ...
            <div className="relative z-10 mx-auto max-w-5xl px-6">
                    ...
                    <div className="grid gap-6 md:grid-cols-4">
                        {STEPS.map((step, i) => (
                            ...
                            >
                                ...
                                <p className="mt-2 text-xs text-white/80">{step.description}</p>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="text-center">
                    ...
                    <p className="scroll-reveal mx-auto mb-10 max-w-2xl text-lg text-white/80">
                    ...
                    <div className="scroll-reveal mx-auto mb-12 max-w-xl">
                        <p className="mb-4 text-xs font-bold uppercase tracking-wider text-white/70">What You&apos;ll Discover</p>
                        <div className="flex flex-wrap justify-center gap-3">
                            {DISCOVERS.map((item) => (
                                <div key={item} className="flex items-center gap-2 rounded-full bg-white/[0.06] px-4 py-2 text-xs font-bold text-white/90" style={{ backdropFilter: 'blur(8px)' }}>
                    ...
                    {/* Guarantee */}
                    <p className="scroll-reveal mb-8 text-sm text-white/70">
